...
import com.example.endlessrunner.be.PauseButton;
import com.example.endlessrunner.be.Player;
import com.example.endlessrunner.bll.IScene;
import com.example.endlessrunner.bll.managers.CloudManager;
import com.example.endlessrunner.bll.managers.GravityManager;
import com.example.endlessrunner.bll.managers.HealthManager;
import com.example.endlessrunner.bll.managers.ObstacleManager;
...
public class GamePlayScene implements IScene {
    ...
    public void draw(Canvas canvas) {
        ...
        if (mGameOver) {
            ...
            drawCenterText(canvas, paint, "Trò chơi kết thúc!", "Điểm: " + mScore);
        }
    }
    ...
    private void drawScore(Canvas canvas, Paint paint) {
        ...
        paint.setColor(Color.WHITE);
        paint.setShadowLayer(5, 0, 0, Color.BLACK);
        canvas.drawText("Điểm: " + mScore, 50, 50 + paint.descent() - paint.ascent(), paint);
    }
    ...
    private void newGame() {
        ...
        mObstacleManager = new ObstacleManager(300, 100, 100, Color.BLACK);
